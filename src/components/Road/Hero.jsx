        ...
        <section className="NFT_booking_hero">
              ...
              <div id="carouselExampleControls" className="carousel slide pointer-event" data-ride="carousel" data-interval="false">
                  <div className="carousel-inner">
                    <div className="carousel-item active" data-step="1">
                      <img className="d-block w-100" src="images/NFT_img.webp" alt="First slide" />
                    </div>
                    <div className="carousel-item" data-step="2">
                      <img className="d-block w-100" src="images/NFT_img.webp" alt="Second slide" />
                    </div>
                    <div className="carousel-item" data-step="3">
                      <img className="d-block w-100" src="images/NFT_img.webp" alt="Third slide" />
                    </div>
              <div className="carousel-item" data-step="4">
                      <img className="d-block w-100" src="images/NFT_img.webp" alt="Forth slide" />
                    </div>
                  </div>
                
                </div>
              {/* <!-- <img src="images/NFT_img.webp" alt="" className="w-100"> --> */}
          </div>
          <div className="container padding-170">
              ...
              <div className="progress-part ">
                ...
                <div className="progress-bar progress-bar-success" role="progressbar" aria-valuenow="1" aria-valuemin="1" aria-valuemax="5" style="width: 25%;"></div>
              </div>
                  </div>
