                ...
                <div className="row">
                    <div className="col-md-6 whitepapper_col">
                        ...
                        <div className="buttons">
                            <a href="#!" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="450" className="Btn__ white_papper_btn text-white">Download Whitepaper<img src="images/white_arrow.png" alt="" /></a>
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="our_ehiter_papper" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
                            <img src="images/nft_img_02.webp" alt="" className="w-100" />
                        </div>
                    </div>
                </div>
            </div>
