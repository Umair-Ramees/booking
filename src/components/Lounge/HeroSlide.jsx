        ...
        <section className="hero_section NFT_lounge">
            <div id="heroslider" className="carousel slide" data-ride="carousel">
                ...
                <div className="carousel-item active">
                    <img className="d-block w-100" src="images/lounge_slider_01.webp" alt="First slide" />
                </div>
                <div className="carousel-item">
                    <img className="d-block w-100" src="images/lounge_slider_01.webp" alt="Second slide" />
                </div>
                <div className="carousel-item">
                    <img className="d-block w-100" src="images/lounge_slider_01.webp" alt="Third slide" />
                </div>
                </div>
                ...
                <div className="row">
                    <div className="col-md-12 col-sm-12 col-12 col-lg-6">
                        ...
                        <div className="buttons">
                            <a href="#!" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="450" className="Btn__" data-toggle="modal" data-target="#exampleModalCenter">Mint Now <img src="images/arrow.png" className="hover_none" alt="" /><img src="images/white_arrow.png" alt="" className="hover_block" /></a>
                            ...
                            <div className="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                ...
                                <div className="modal-content p-4">
                                    ...
                                    <div className="modal-footer justify-content-center mt-4">
                                        <div className="buttons">
                                            <a href="#!"className="Btn__">Mint Now <img src="images/arrow.png" className="hover_none" alt="" /><img src="images/white_arrow.png" alt="" className="hover_block" /></a>
                                        </div>
                                    </div>
                                </div>
                                </div>
